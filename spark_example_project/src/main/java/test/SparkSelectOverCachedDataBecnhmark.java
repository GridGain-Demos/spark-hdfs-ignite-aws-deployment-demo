...
public class SparkSelectOverCachedDataBecnhmark {
    public static void main(String[] args) {
        ...
        long initialDataLoadingTime = System.nanoTime();;

        SparkConf sparkConf = new SparkConf()
                .setAppName("SparkSelectOverCachedDataBecnhmark");
        ...
        person.persist(StorageLevel.MEMORY_ONLY());

        Dataset < Row > company = session.read()
                .format("parquet")
                .load(company_data);

        company.persist(StorageLevel.MEMORY_ONLY());

        initialDataLoadingTime = System.nanoTime() - initialDataLoadingTime;
        ...
        System.out.println("Initial data loading time: " + initialDataLoadingTime);
